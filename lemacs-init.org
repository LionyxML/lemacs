...
#+BEGIN_SRC emacs-lisp
  ...
  (defcustom lemacs-ascii-art 'lemacs
...
#+BEGIN_SRC emacs-lisp
  (use-package tab-bar
    ...
    (defun lemacs/renumber-tabs (&rest _)
      ...
      (let ((tabs (tab-bar-tabs)))
        (dotimes (i (length tabs))
          (let* ((tab (nth i tabs))
                 ...
                 (file-name "") ;; You can extend this logic if needed
...
#+BEGIN_SRC emacs-lisp
  (use-package persp-mode
    ...
    ;; Makes persp name appear on global-mode-string, hence it appears
    ;; on tab-bar right position also

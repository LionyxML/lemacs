...
#+BEGIN_SRC emacs-lisp
  ...
  (when (eq lemacs-lsp-client 'lsp-mode)
    (use-package lsp-mode
      ...
      ;; Ruby - ruby-lsp instead of solargraph
      :config
      ...
      ;;   :priority 1   ;; Same as default, just priority increased
      ...
      ;; ;; Ruby - solargraph
      (setq lsp-solargraph-use-bundler nil)    ;; Use Bundler if the project uses it
      (setq lsp-solargraph-multi-root nil)     ;; Only work in the current project
      (setq lsp-solargraph-diagnostics t)      ;; Enable diagnostics
      (setq lsp-solargraph-log-level "warn")

...
This configuration is for =personal use= and is currently *unstable*.

I officially maintain [[https://github.com/LionyxML/emacs-solo][Emacs-Solo]] and [[https://github.com/LionyxML/emacs-kick][Emacs-Kick]]. If you are looking
for something =maintained, curated, documented, and stable=, you
should =use one of those instead=.

As a result, =LEmacs= has become somewhat *obsolete* over time.

On =23 Jan 2026=, I started a general cleanup: removing a lot of
complexity, simplifying many parts, and making it *installable*
again. It is now much more minimal and usable — but =far simpler= and
=not representative of the screenshots= you may find in the
repository.

If you want a supported setup with regular improvements, updates, and
sane defaults:
- use [[https://github.com/LionyxML/emacs-solo][Emacs-Solo]] for a focused, modern, built-in-first approach
- use [[https://github.com/LionyxML/emacs-kick][Emacs-Kick]] if you’re coming from (neo)vim and want a smoother transition

**LEmacs is (and will always be) experimental.** You’ve been warned 🙂
